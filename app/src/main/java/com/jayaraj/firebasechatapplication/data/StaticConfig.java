package com.jayaraj.firebasechatapplication.data;
...
public class StaticConfig {
    ...
    public static String STR_EXTRA_NAME = "name";
    public static String STR_EXTRA_DOB = "dob";
...
//    public static String UID = "6kU0SbJPF5QJKZTfvW1BqKolrx22";
    ...
    public static String INTENT_KEY_CHAT_STATUS = "roomid";
    public static String STR_EXTRA_STATUS = "status";
